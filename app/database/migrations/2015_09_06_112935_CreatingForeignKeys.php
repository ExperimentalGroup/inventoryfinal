...
class CreatingForeignKeys extends Migration {
	...
	public function up()
	{
		...
		Schema::table('tblDeliveries', function($table){
			...
			$table->foreign('strOrdDlvry')->references('strOrdersID')->on('tblOrders');
		});
		...
		Schema::table('tblReleases', function($table){
			$table->foreign('strReleaseBrchID')->references('strBrchID')->on('tblBranches');
			$table->foreign('strReleaseBy')->references('strEmpID')->on('tblEmployees');
		});

		Schema::table('tblReleaseNotes', function($table){
			$table->foreign('strReleaseID')->references('strReleasesID')->on('tblReleases');
		});

		Schema::table('tblReleaseDetails', function($table){
			$table->foreign('strReleaseProducts')->references('strProdID')->on('tblProducts');
			$table->foreign('strReleaseHeaderID')->references('strReleasesID')->on('tblReleases');
		});
	...
	public function down()
	{
		...
		Schema::table('tblReleases', function($table){
			$table->dropColumn('strReleaseBrchID');
			$table->dropColumn('strReleaseBy');
		});

		Schema::table('tblReleaseNotes', function($table){
			$table->dropColumn('strReleaseID');
		});

		Schema::table('tblReleaseDetails', function($table){
			$table->dropColumn('strReleaseProducts');
			$table->dropColumn('strReleaseHeaderID');
		});
		// Schema::table('tblReqDelivery', function ($table) {
